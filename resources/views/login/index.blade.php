            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="/login" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" required class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="Enter your username" value="{{ old('username') }}" autofocus/>
                  @error('username')
