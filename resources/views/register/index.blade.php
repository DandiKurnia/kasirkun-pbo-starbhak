@extends('layouts.partials_log_reg.main')
            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="/register" method="POST">
                ...
                <div class="mb-3">
                        ...
                        <select class="form-select @error('role') is-invalid @enderror" name="role" id="exampleFormControlSelect1" aria-label="Default select example" value="{{ old('role') }}">
                          <option selected value="{{ old('role') }}">Open this select menu</option>
